...
var require$$7$1 = require('assert');
...
contentDisposition$1.exports.parse = parse$b;
...
var basename$1 = require$$1__default$1["default"].basename;
...
var relative$2 = require$$1__default$1["default"].relative;
...
var createError$3 = httpErrors$1.exports;
var eql = deepEqual$1.exports;

var httpAssert = assert$2;

function assert$2 (value, status, msg, opts) {
  if (value) return
  throw createError$3(status, msg, opts)
}

assert$2.fail = function (status, msg, opts) {
  assert$2(false, status, msg, opts);
};

assert$2.equal = function (a, b, status, msg, opts) {
  assert$2(a == b, status, msg, opts); // eslint-disable-line eqeqeq
};

assert$2.notEqual = function (a, b, status, msg, opts) {
  assert$2(a != b, status, msg, opts); // eslint-disable-line eqeqeq
};

assert$2.ok = function (value, status, msg, opts) {
  assert$2(value, status, msg, opts);
};

assert$2.strictEqual = function (a, b, status, msg, opts) {
  assert$2(a === b, status, msg, opts);
};

assert$2.notStrictEqual = function (a, b, status, msg, opts) {
  assert$2(a !== b, status, msg, opts);
};

assert$2.deepEqual = function (a, b, status, msg, opts) {
  assert$2(eql(a, b), status, msg, opts);
};

assert$2.notDeepEqual = function (a, b, status, msg, opts) {
  assert$2(!eql(a, b), status, msg, opts);
};
...
const URL = require$$0__default$5["default"].URL;
const net = require$$1__default$3["default"];
const accepts$1 = accepts;
const contentType$1 = contentType;
const stringify = require$$0__default$5["default"].format;
...
const debug$3 = src$2.exports('koa:application');
...
pathIsAbsolute$1.exports = process.platform === 'win32' ? win32 : posix;
pathIsAbsolute$1.exports.posix = posix;
pathIsAbsolute$1.exports.win32 = win32;
...
var join$1 = require$$1__default$1["default"].join;
var normalize$1 = require$$1__default$1["default"].normalize;
var pathIsAbsolute = pathIsAbsolute$1.exports;
var resolve$2 = require$$1__default$1["default"].resolve;
var sep$1 = require$$1__default$1["default"].sep;
...
var resolvePath_1 = resolvePath$1;
...
function resolvePath$1 (rootPath, relativePath) {
  ...
  if (path.indexOf('\0') !== -1) {
    throw createError$2(400, 'Malicious Path')
  }
  ...
  if (UP_PATH_REGEXP.test(normalize$1('.' + sep$1 + path))) {
    throw createError$2(403)
  }

  // join the relative path
  return normalize$1(join$1(resolve$2(root), path))
}
...
const util = require$$1__default["default"];
const debug$2 = src$2.exports('koa-send');
const resolvePath = resolvePath_1;
const createError$1 = httpErrors$1.exports;
const assert$1 = require$$7__default["default"];

const stat = util.promisify(fs$3.stat);
const access = util.promisify(fs$3.access);
...
async function send$1 (ctx, path, opts = {}) {
  assert$1(ctx, 'koa context required');
  assert$1(path, 'pathname required');

  // options
  debug$2('send "%s" %j', path, opts);
  const root = opts.root ? normalize(resolve$1(opts.root)) : '';
  const trailingSlash = path[path.length - 1] === '/';
  path = path.substr(parse$6(path).root.length);
  ...
  ctx.body = fs$3.createReadStream(path);
...
const debug$1 = src$1.exports('koa-static');
const { resolve } = require$$1__default$1["default"];
const assert = require$$7__default["default"];
const send = koaSend;
...
var json$1 = async function(req, opts) {
  req = req.req || req;
  opts = utils$5.clone(opts);
  ...
  const str = await raw$2(inflate$2(req), opts);
  try {
...
var form$1 = async function(req, opts) {
  req = req.req || req;
  opts = utils$1.clone(opts);
  ...
  const str = await raw$1(inflate$1(req), opts);
  try {
...
var text$1 = async function(req, opts) {
  req = req.req || req;
...
var any = async function(req, opts) {
  req = req.req || req;
  opts = opts || {};
...
var koaBodyparser = function (opts) {
  opts = opts || {};
  ...
  async function parseBody(ctx) {
    if (enableJson && ((detectJSON && detectJSON(ctx)) || ctx.request.is(jsonTypes))) {
      return await parse$2.json(ctx, jsonOpts);
    }
    if (enableForm && ctx.request.is(formTypes)) {
      return await parse$2.form(ctx, formOpts);
    }
    if (enableText && ctx.request.is(textTypes)) {
      return await parse$2.text(ctx, textOpts) || '';
    }
    if (enableXml && ctx.request.is(xmlTypes)) {
      return await parse$2.text(ctx, xmlOpts) || '';
    }
    return {};
  }
};
...
const debug = src$2.exports('koa-router');
...
const {promises: fs, constants: fsConstants} = require$$0__default$2["default"];
...
const Koa = application.exports;
const KoaStatic = koaStatic;
const bodyParser = koaBodyparser;
const Router = router$1;
const { readFileSync, readdirSync, statSync, writeFileSync, existsSync, mkdirSync, rmSync } = require$$0__default$2["default"];
const open = open_1;
const { join } = require$$1__default$1["default"];
